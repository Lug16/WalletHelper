...
namespace WalletHelper.Interfaces
{
    ...
    public interface IPayment
    {
        ...
        IEnumerable<Payment> GetPaymentsDay();
        IEnumerable<Payment> GetPayments(DateTime begin, DateTime end);
        /// <summary>
        /// Obtiene los movimientos según el filtro PaymentValues.
        /// </summary>
        /// <param name="paymentValues">Filtro aplicar a los movimientos.</param>
        /// <returns></returns>
        IEnumerable<PaymentValue> GetPaymentValues(PaymentValues paymentValues);
    }
}
